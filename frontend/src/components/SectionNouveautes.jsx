...
const SectionNouveautes = () => {
    ...
    return (
        ...
        <div className="relative bottom-32 w-full">
                <img src="Gobelets Dessin PUB 3.png" alt="Gobelet" className="absolute -top-32 left-20 max-[767px]:w-36 max-[767px]:top-10" />
            </div>
        <div className="w-11/12 mb-20 justify-center items-center mx-auto bg-white px-8">
            ...
            <div className="flex max-[767px]:flex-col justify-between items-start">
                <div className="w-3/4 mr-20 max-[767px]:w-full">
                    <div className="border-2 border-custom-blue flex flex-row p-4 rounded-lg mb-4">
                        <div className='ml-4 mr-4'>
                        <button className="bg-white border-2 border-custom-blue text-custom-blue px-4 py-2 rounded mb-12">PRODUITS</button>
                        <p className="text-xl font-bold text-custom-green mb-60" style={{fontSize: '38px'}}>De nouvelles boîtes en inox réemployables avec couvercles à clipser !</p>
                        <button className="bg-white border-2 border-custom-blue text-custom-blue px-4 py-2 rounded">Bouton</button>
                        </div>
