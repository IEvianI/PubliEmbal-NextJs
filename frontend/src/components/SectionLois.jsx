    ...
    VOUS ACCOMPAGNER<br /> AVEC DES GAMMES CONFORMES AUX LOIS
            ...
            <div className="flex max-[767px]:flex-col-reverse justify-between items-start gap-12">
                <div className="w-1/2 max-[767px]:w-full pr-4">
                    ...
                    <div className='max-w-lg rounded-lg p-8' style={{padding: '30px', backgroundImage: 'url(/border-first-section.png)', backgroundSize: 'contain',
       backgroundPosition: 'center',
       backgroundRepeat: 'no-repeat', paddingRight:'70px', zIndex: 10}}>
